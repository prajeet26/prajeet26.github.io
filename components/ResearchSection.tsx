...
const getPaperInitials = (title: string) =>
  title
    .split(/\s+/)
    .filter(Boolean)
    .slice(0, 3)
            ...
            <div className="w-full md:w-56 shrink-0 rounded-lg overflow-hidden shadow-sm border border-gray-200 dark:border-neutral-800 relative group-hover:shadow-md transition-all duration-300">
               ...
               <div className="aspect-[4/3] w-full bg-gray-100 dark:bg-neutral-900 relative">
                  {paper.imageUrl ? (
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-neutral-100 via-white to-neutral-200 px-6 text-center dark:from-neutral-900 dark:via-neutral-950 dark:to-neutral-900">
                      <span className="mb-2 text-3xl font-bold tracking-[0.2em] text-primary/70">
                        {getPaperInitials(paper.title)}
                      </span>
                      <span className="text-xs font-medium uppercase tracking-[0.25em] text-gray-500 dark:text-neutral-500">
                        Image Coming Soon
                      </span>
                    </div>
                  )}
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3 mb-4">
                {paper.paperUrl ? (
                  ...
                  >
                    {paper.linkLabel ?? "Paper"} <ExternalLink size={10} />
                  </a>
                ) : (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 text-xs font-semibold tracking-wide text-gray-500 border border-gray-300 rounded-full bg-gray-100 dark:text-neutral-400 dark:border-neutral-700 dark:bg-neutral-900">
                    Link Soon
                  </span>
                )}
              </div>
